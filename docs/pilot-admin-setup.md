...
- [ ] The **8 parked workflow-template migrations live in `supabase/migrations-parked/guided-procedures/`** — they are a
      separate, retired work stream and must **not** be applied for the pilot (see [RUNBOOK.md §4](RUNBOOK.md)).
